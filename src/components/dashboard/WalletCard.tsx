  ...
  return (
    <div className="bg-gradient-to-br from-[#1c232d] to-[#11151d] p-6 md:p-8 rounded-[32px] shadow-2xl flex flex-col items-center text-center relative overflow-hidden border border-white/5">
      ...
      <div className="text-white text-4xl md:text-5xl font-black mb-8 tracking-tighter">
        {(userBalance || 0).toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })} <span className="text-xs font-medium text-gray-500">{currency}</span>
      </div>
      ...
      <div className="flex gap-3 w-full">
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent className="w-[95%] max-w-[425px] h-[85vh] overflow-hidden bg-[#11151d] border-gray-800 text-white flex flex-col p-0 rounded-[32px]" dir="rtl">
            <div className="p-6 pb-2 text-right shrink-0">
              <DialogHeader>
            ...
            <ScrollArea className="flex-1 px-6 py-2">
              <div className="grid gap-4 py-2">
                ...
                <div className="grid gap-2 text-right pb-4">
                  ...
                  {imageProof && (
                    <div className="mt-2 rounded-2xl overflow-hidden border border-gray-800 h-40 relative group">
