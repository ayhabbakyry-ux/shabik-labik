...
const services = [
  ...
  { id: 'syriatel-units', name: "Syriatel Instant Units", icon: Smartphone, color: "text-red-500", bg: "bg-red-50" },
  { id: 'mtn-cash', name: "MTN Cash Recharge", icon: CreditCard, color: "text-yellow-600", bg: "bg-yellow-50" },
